...
const useNetworkStatus = (): [
  ...
  const logStateTransition = (
    ...
    console.log(
      `Network State Transition: ${fromState} -> ${toState} (${servicePortalDuration}ms)`
    );
  };
            ...
            .then((response) => {
              ...
              if (AppState.currentState === "active") {
                ...
                if (
                  ...
                  logPollCheckpoints(
                    `Poll success, duration: ${requestDuration}ms`
                  );
                ...
                logPollCheckpoints(
                  "Poll result ignored due to app in background"
                );
              }
            })
            .catch(() => {
